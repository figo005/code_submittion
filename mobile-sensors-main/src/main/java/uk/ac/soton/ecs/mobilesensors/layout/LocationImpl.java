...
public class LocationImpl extends Point2D implements Location, Serializable {
	...
	protected LocationImpl(double x, double y, AccessibilityGraphImpl parent,int id) {
		coordinates = new Point2D.Double(x, y);
		this.parent = parent;
		this.id=id;
	}
	
	protected LocationImpl(double x, double y, AccessibilityGraphImpl parent,int id, double riskProbability) {
		coordinates = new Point2D.Double(x, y);
		this.parent = parent;
		this.id=id;
