...
public class Simulation {
	...
	public void initialize() {
		...
		int number=environment.getAccessibilityGraph().getLocationCount();
		Random rd1 = new Random();
		
//		for (Sensor sensor : sensors)
//		{ int random1=rd1.nextInt(number);
//			sensor.setInitialLocation(environment
//					.getAccessibilityGraph().getLocationFromID(random1));
//		}
		for (Sensor sensor : sensors)
		{ int random1=rd1.nextInt(number);
			sensor.setInitialLocation(environment
